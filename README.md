...
A group of random strangers from the interwebs creating the next gen API to close the gap between different kinds of devices and a web app to control all of them at the same time. 
...
Creating a unified way to control all the devices you want with one single master pc through a REST API and a visual UI in the browser of your choice. 
...
- Change the projection based on detected people in the room using kinect
