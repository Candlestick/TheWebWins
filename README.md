...
A group of people from the interwebs creating the next gen API to close the gab between hardware sensors, projectors, led, nfc, kinect, webcams, audio systems and a web app to controll all of them at the same time. 
